...
export const visiMisi = {
  visi: "Terwujudnya Desa Sukamaju yang mandiri secara ekonomi, sehat warganya, dan lestari lingkungannya.",
  misi: [
...
export const sejarahDesa = [
  "Desa Sukamaju terbentuk pada 1946 dari penggabungan tiga permukiman lama di sekitar aliran Sungai Tirto: Krajan, Sidorejo, dan Ngadirejo. Ketiganya sejak lama berbagi jaringan irigasi yang sama, sehingga penggabungan dianggap wajar oleh warga saat itu.",
